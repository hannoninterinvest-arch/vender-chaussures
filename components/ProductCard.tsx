...
export function ProductCard({ product }: { product: Product }) {
  return (
    <article className="group">
      <div className="gold-frame relative overflow-hidden rounded-[4px] bg-[#141414]">
        {product.isNew && (
      ...
      <h3 className="mt-3 text-[13px] font-semibold tracking-[0.14em] uppercase text-[#EDE8DE]">
        {product.name}
      </h3>
      <Link
